...
const Sparkles = ({ color }) => { /* ... Sparkles component code remains the same ... */ };
...
const Card = ({ card }) => {
    ...
    return (
        // Added a wrapper for the reflection pseudo-element
        <div className="card-reflection-wrapper">
            <div className="group w-56 h-80 perspective-1000" onClick={handleCardClick} style={{'--card-image': `url(${card.imageUrl})`}}>
                <motion.div
